...
export class InitialSchema1784403558091 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_331b0c204ba6573fb9fc68bde6"`);
