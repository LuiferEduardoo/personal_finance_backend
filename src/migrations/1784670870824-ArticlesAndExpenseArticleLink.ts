...
export class ArticlesAndExpenseArticleLink1784670870824 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."article_type" AS ENUM('product', 'service', 'other')`);
        await queryRunner.query(`CREATE TABLE "articles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "category_id" uuid, "name" text NOT NULL, "type" "public"."article_type" NOT NULL DEFAULT 'product', "unit" "public"."unit_of_measure" DEFAULT 'unit', "brand" text, "is_active" boolean NOT NULL DEFAULT true, "notes" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "articles_name_unique" UNIQUE ("user_id", "name", "type"), CONSTRAINT "PK_0a6e2c450d83e0b6052c2793334" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_products_article"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_articles_user"`);
        await queryRunner.query(`DROP TABLE "articles"`);
        await queryRunner.query(`DROP TYPE "public"."article_type"`);
    }
