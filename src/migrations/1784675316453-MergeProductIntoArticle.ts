...
export class MergeProductIntoArticle1784675316453 implements MigrationInterface {
  ...
  `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_articles_barcode"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cycles_article"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cycles_one_open"`);
        await queryRunner.query(`DROP INDEX "public"."idx_product_purchases_article"`);
